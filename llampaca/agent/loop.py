...
class Agent:
    ...
    def send(self, user_input: str) -> Generator[Tuple[str, Any], None, None]:
        ...
        for _ in range(self.max_iterations):
            ...
            try:
                for kind, data in self.client.chat_stream_events(
            ...
            if prompt_mode:
                ...
                result = self._execute_with_confirmation(name, arguments_json)
    ...
    def _execute_with_confirmation(self, name: str, arguments_json: str) -> str:
        """
